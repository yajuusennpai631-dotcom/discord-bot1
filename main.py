...
# 実行した人の権限をその場で判定し、非公開(ephemeral)で出し分けるように強化
...
# 視聴中(watching)の枠組みを維持したまま、ステータステキストを自由に上書きできるように調整
