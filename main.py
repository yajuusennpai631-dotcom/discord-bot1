...
# 🔘【新仕様】コマンド引数で直接ロールを指定して設置するロールパネルコマンド
@bot.tree.command(name="server_role_panel", description="【管理】指定したロール（最大5つ）を取得できるボタン付きパネルを送信します")
async def server_role_panel(
    ...
    embed = discord.Embed(
        ...
        color=discord.Color.from_rgb(46, 204, 113) # きれいな緑色
    )
    ...
    await interaction.followup.send("✅ 指定されたロールでパネルを設置しました！", ephemeral=True)
